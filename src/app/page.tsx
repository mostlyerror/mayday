    ...
    try {
      ...
      if (progressRes.ok) {
        ...
        if (progress.status === 'running') {
          // Auto-resume polling if scan is running
          setScanning(true);
          setScanProgress({
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 mb-8">
        ...
        <div className="flex gap-3">
          <button
            onClick={runScan}
            disabled={scanning}
            className="flex-1 px-6 py-3 bg-gradient-to-r from-orange-500 to-red-600 text-white font-semibold rounded-lg hover:from-orange-600 hover:to-red-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-xl transition-all"
          >
            {scanning ? (
              <>
          ...
          {scanning && (
            <button
              onClick={cancelScan}
              className="px-6 py-3 bg-gray-600 text-white font-semibold rounded-lg hover:bg-gray-700 flex items-center gap-2 shadow-lg hover:shadow-xl transition-all"
            >
              <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
